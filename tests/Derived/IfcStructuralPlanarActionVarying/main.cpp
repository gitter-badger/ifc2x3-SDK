...
int main(int n, char **p)
{
    ...
    Step::RefPtr< ifc2x3::IfcStructuralPlanarActionVarying > StructuralPlanarActionVarying = eds->createIfcStructuralPlanarActionVarying();
    TEST_ASSERT(StructuralPlanarActionVarying->getVaryingAppliedLoads().empty());
    ...
    StructuralPlanarActionVarying->setVaryingAppliedLoadLocation(ShapeAspect);

    {
        ...
        StructuralPlanarActionVarying->getSubsequentAppliedLoads().push_back(load);
    }
    ...
    ifc2x3::List_IfcStructuralLoad_3_n ListIfcStructuralLoad = StructuralPlanarActionVarying->getVaryingAppliedLoads();
    if(ListIfcStructuralLoad[0]->isOfType(ifc2x3::IfcStructuralLoadLinearForce::getClassType()))
    {
...

    {
        ...
        StructuralPlanarActionVarying->setAppliedLoad(load);
    }

    ListIfcStructuralLoad = StructuralPlanarActionVarying->getVaryingAppliedLoads();
